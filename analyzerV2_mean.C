...
void analyzerV2_mean()
{
  ...
  analyze("A1_LED_ColTests_Fiber3_VMIN_SIPM1.txt","A1_LED_ColTests_Fiber3_TIME.txt",true);

}


void analyze(const char* datafile, const char* timedata, bool PEConvert = true)
{
  ...
  for(int i = 0; i < totalBins ; i++)
    {
      ...
      file>>meanval_d;
      means.push_back(PEmult*meanval_d);
    }
  ...
  c1->Print("canvas1.png");
  c2->Print("canvas2.png");
