...
//Options//-----------------------------------------------------------------------------
//
//rot     - This option flips and rotates the histogram to preserve the test view of the
//          scintillator.
//average - This option normalizes the histogram to the mean value for all the bins.
//varNorm - This option normalizes the histogram by the mean value for a set of bins
//          bounded by a region inside the histogram read in by loc[10]. One can set
//          these bounds in the code. Average must be enabled for this option to function.
//
//---------------------------------------------------------------------------------------

void paletteSwap(char loc[20], bool rot = true, bool average = true, bool varNorm = true, bool flip = true)
{
    ...
    TH2D * f1 = new TH2D("f1","f1", xBPositions, 0, 29, yBPositions, 0, 1.5);
