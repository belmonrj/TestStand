...
void analyzer_new_LEDscan()
{
  ...
  doana("20160329-1516",174,54,0,0,false); // large tile, 405 nm, changed alignment...
  doana("20160330-1235",174,54,0,0,false); // large tile, 405 nm, changed alignment...
  doana("20160403-1706",174,54,0,0,false); // large tile, 405 nm, changed alignment...
